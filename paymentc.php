        ...
        <div class="box">
            ...
            <div class="pcb">
                ...
                <form id="cf"
                    ...
                    method="POST">
                    <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="<?php echo $API; ?>"

                        data-amount="<?php echo $amount; ?>" 
                         data-currency="INR" 
                        data-id="<?php echo $tid; ?>" 
                        data-buttontext="Pay Now" data-description="Yearly Play" data-image="assets/images/logo.png"
                        data-name="<?php echo "Payment"; ?>" data-prefill.name="<?php echo $name; ?>"
                        data-prefill.email="<?php echo $email; ?>" data-theme.color="#9cfcf8">
                    </script>
