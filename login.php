                    ...
                    <form action="" method="post">
                        <div class="rlinp">
                            ...
                            <div class="gender">
                                ...
                                <br>
                                <input type="radio" name="gen" id="gen" value="male" requierd>
                                <label for="gen">Male</label>
                                <input type="radio" name="gen" id="gen" value="female" requierd>
                                <label for="gen">Female</label>
                                <input type="radio" name="gen" id="gen" value="other" requierd>
